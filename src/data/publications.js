...
const publications = [
   {
    "actualTitle": "[MDTS'26] A 65-nm RRAM-Based Digital In-Memory Computing Chip for Streaming-based Processing: Fabrication and Experimental Demonstration",
  ...
  {
    "actualTitle": "[DCAS'26] Vulnerability Analysis of Timing Side-Channels in Multi-Tenant ReRAM Crossbars",
  ...
  {
    "actualTitle": "[MDTS'25] On the Design and Fabrication of PATH-based In-Memory Computing Multipliers",
  ...
  {
    "actualTitle": "[TODAES'25] LOGIC: Logic Synthesis for Digital In-Memory Computing",
  ...
  {
    "actualTitle": "[ICCAD'24] Equivalence Checking for Flow-Based Computing using Iterative SAT Solving",
  ...
  {
    "actualTitle": "[DAC'24] Execution Sequence Optimization for Processing In-Memory using Parallel Data Preparation",
  ...
  {
    "actualTitle": "[DAC'24] Synthesis of Compact Flow-based Computing Circuits from Boolean Expressions",
  ...
  {
    "actualTitle": "[ASP-DAC'24] Towards Area-Efficient Path-Based In-Memory Computing using Graph Isomorphisms",
  ...
  {
    "actualTitle": "[ASP-DAC'24] READ-based In-Memory Computing using Sentential Decision Diagrams",
  ...
  {
    "actualTitle": "[NAECON'24] Automated Synthesis of Hardware Designs using Symbolic Feedback and Grammar Constrained Decoding in Large Language Models",
  ...
  {
    "actualTitle": "[TCAD'23] STREAM: Towards READ-based In-Memory Computing for Streaming Based Processing for Data-Intensive Applications",
  ...
  {
    "actualTitle": "[ICCAD'23] Automated Synthesis for In-Memory Computing",
  ...
  {
    "actualTitle": "[ICCAD'23] Verification of Flow-Based Computing Systems using Bounded Model Checking",
  ...
  {
    "actualTitle": "[ICCAD'23] Path-based Processing using In-Memory Systolic Arrays for Accelerating Data-Intensive Applications",
  ...
  {
    "actualTitle": "[ICCD'23] Input-Aware Flow-Based In-Memory Computing",
  ...
  {
    "actualTitle": "[DAC'23] UpTime: Towards Flow-based In-Memory Computing with High Fault-Tolerance",
  ...
  {
    "actualTitle": "[ASP-DAC'23] Discovering the In-Memory Kernels of 3D Dot-Product Engines",
  ...
  {
    "actualTitle": "[TCAD'23] PATH: Evaluation of Boolean Logic using Path-based In-Memory Computing Systems",
  ...
  {
    "actualTitle": "[ICCAD'22] Logic Synthesis for Digital In-Memory Computing",
  ...
  {
    "actualTitle": "[DAC'22] Towards Resilient Analog In-Memory Deep Learning via Data Layout Re-Organization",
  ...
  {
    "actualTitle": "[DATE'22] Hybrid Digital-Digital In-Memory Computing",
  ...
  {
    "actualTitle": "[ASP-DAC'22] STREAM: Towards READ-based In-Memory Computing for Streaming based Data Processing",
  ...
  {
    "actualTitle": "[ICCAD'21] Hybrid Anlog-Digital In-Memory Computing",
  ...
  {
    "actualTitle": "[MICRO'21] LADDER: Architecting Content and Location-aware Writes for Crossbar Resistive Memories",
